          ...
          <DrawerBody>
            ...
            <Box>
              ...
              <Flex mt={"10px"}>
                ...
                />
                <Box mt={"5px"} ml={"15px"}>
                  <Link to="#">Profile Verification</Link>
                </Box>
              </Flex>
            ...
            <Box>
              ...
              <Flex mt={"10px"}>
                ...
                />
                <Box mt={"5px"} ml={"15px"}>
                  <Link to="#">Zoomcar Host Vehicles Policies</Link>
                </Box>
              </Flex>
